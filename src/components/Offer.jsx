            ...
            <div className='grid grid-cols-2 items-center'>
              <div>
                  ...
                  <div className="absolute top-10 left-9 text-center uppercase -rotate-45">
                    {item.dishName === 'Chicken Burger'
                      ? <div className=''>
                        ...
                        <p className='font-bold font-serif text-4xl'>${item.price}</p>
                      </div>
                ...
                <div className='space-y-2 mt-3'>
                  <div className='flex'>
                    <p className='border-y border-y-background uppercase text-xs font-josefin tracking-widest'>{item.percentage}% offer going</p>
                  </div>
                  <div className='space-y-2'>
                    <Heading4 title={item.dishName} />
                    <p className='font-josefin text-sm font-light'>{item.detail}</p>
                  </div>
                </div>
              </div>
              <div>
